...
export function OrganizationSchema() {
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    knowsAbout: ['Baby Monitoring', 'Infant Health', 'Contactless Sensing', 'AI Health Technology', 'Baby Sleep Analysis'],
  })}} />;
}
...
export function WebsiteSchema() {
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
    ...
    description: "India's most advanced contactless AI baby monitor",
    inLanguage: 'en-IN',
