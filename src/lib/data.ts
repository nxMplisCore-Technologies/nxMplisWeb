...
export const ARTICLES = [
  {
    ...
    author: 'Deepak Singh',
    authorTitle: 'Co-founder & CEO, Nxmliscore · IIT Alumni',
    date: '2025-04-28',
    updatedDate: '2025-04-28',
    category: 'Baby Health',
    readTime: '8 min read',
    imageUrl: '/anvaya-lifestyle.webp',
